...
require 'packer'.startup(function(use)
	...
	use {
		'catppuccin/nvim',
		config = function() require 'core.configs.theme' end
	}

	use {
		'lukas-reineke/indent-blankline.nvim',
		config = function() require 'core.configs.indent-blankline' end
	}
	...
	use {
		...
		config = function() require 'core.configs.marks' end
	}
	...
	use {
		...
		config = function() require 'core.configs.autopairs' end
	}
	...
	use {
		...
		config = function() require 'core.configs.toggleterm' end
	}
	...
	use {
		...
		requires = {
			'neovim/nvim-lspconfig', 'SmiteshP/nvim-navic', 'nvim-tree/nvim-web-devicons'
		},
		config = function() require 'core.configs.barbecue' end
	}
	...
	use {
		...
		config = function() require 'core.configs.barbar' end
	}
	...
	use {
		...
		config = function() require 'core.configs.neo-tree' end
	}
